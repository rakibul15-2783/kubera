                ...
                <form action="{{ route('project.submit') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="project_category" id="project_category" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="estimate_budget" id="estimate_budget" step="0.01" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="is_donated" id="donated_yes" value="1">
                                <label class="form-check-label" for="donated_yes">Yes</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="is_donated" id="donated_no" value="0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="donation_amount" id="donation_amount" step="0.01">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="prcentage_of_completion" id="prcentage_of_completion" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="team_members" id="team_members" required>
                        </div>
                        @error('team_members')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="your_role" id="your_role" required>
                        </div>
                        @error('your_role')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
